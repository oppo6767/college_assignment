public class main4_4 {
    public static void main(String[] args) {
        ...
        function4_4_1.print_func(week);

        System.out.println("(2)원형 연결 리스트에 [월]노드 삽입하기!");
        function4_4.insertNode(week, "월");
        function4_4_1.print_func(week);

        System.out.println("(3)원형 연결 리스트에 [월] 노드 뒤에 [수]노드 삽입하기!");
        function4_4.insertNode(week, "수");
        function4_4_1.print_func(week);

        System.out.println("(4)원형 연결 리스트에 [수] 노드 뒤에 [금]노드 삽입하기!");
        function4_4.insertNode(week, "금");
        function4_4_1.print_func(week);

        System.out.println("(5)원형 연결 리스트에서 [수] 노드 삭제하기!");
        ListNode4_4 p=function4_4_1.search(week, "수");
        function4_4_1.delete(week, p);
        function4_4_1.print_func(week);
